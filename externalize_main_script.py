...
replacement = '<script src="main_app.js"></script>'
...
if text.count('<script src="main_app.js"></script>') != 1:
    raise SystemExit('main_app.js script tag was not written exactly once')
